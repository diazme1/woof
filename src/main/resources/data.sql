...
VALUES ('Administrador', 99999999, 'admin@woof.com', '0000000000', 'Universidad Nacional de Quilmes', 'Admin@123', 2, now(), null, null )
...
INSERT INTO usuario (nombre, dni, email, telefono, direccion, contrasena, rol, fecha_registro, alias, biografia)
VALUES ('Cliente', 7777777, 'c@gmail.com', '0000000000', 'Universidad Nacional de Quilmes', 'Cliente@123', 1, now(), null, null )
ON CONFLICT (email) DO NOTHING;
