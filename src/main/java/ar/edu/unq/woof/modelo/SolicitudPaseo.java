...
public class SolicitudPaseo {
    ...
    public SolicitudPaseo(ZonaOperativa zona, LocalDateTime horario, String nombrePerro, TamanoPerro tamanoPerro, String raza, Long cliente, Long idCliente, EstadoDePago estadoPago) {
        this.zona = zona;
